...
function add_theme_scripts() {
	...
	wp_enqueue_style( 'mincss', get_template_directory_uri() . '/dest/style.css', array(), '1.2', 'all');
	wp_enqueue_script('jquery', 'https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js', array('jquery')); 
	wp_enqueue_style( 'jquerymobilecss', get_template_directory_uri() . '/js/lib/jquery.mobile-1.4.5.min.css', array(), '1.2', 'all'); 
			
	wp_enqueue_script('jquerymobilejs', get_template_directory_uri() . '/js/lib/jquery.mobile-1.4.5.min.js', array(), '1.4.5');
	wp_enqueue_script( 'cycle', get_template_directory_uri() . '/js/lib/jquery.cycle2.min.js', array(), '1.7'); //true == footer
wp_enqueue_script( 'script', get_template_directory_uri() . '/js/script.js', array ( 'jquery' ), '1.3', true); //true == footer
